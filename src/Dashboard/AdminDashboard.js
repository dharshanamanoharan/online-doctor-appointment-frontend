...
return(
    <>
        <section className="container-fluid admin-panel-section pt-3 pb-5">
            <div className="container admin-panel-container ">
                <div className="row">
                    <ul className="nav nav-pills my-5 " id="dashboard-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <button class="nav-link active" id="dashboard-tab" data-bs-toggle="pill" data-bs-target="#pills-dashboard" type="button" role="tab"><i class="me-3 fa-solid fa-chart-line"></i>Dashboard</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link " id="users-tab" data-bs-toggle="pill" data-bs-target="#pills-users" type="button" role="tab"><i className=" me-3 fa-regular fa-user" />Users</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button class="nav-link" id="doctors-tab" data-bs-toggle="pill" data-bs-target="#pills-doctors" type="button" role="tab" ><i className=" me-3 fa-solid fa-user-doctor" />Doctors</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" id="appointment-tab" data-bs-toggle="pill" data-bs-target="#pills-appointments" type="button" role="tab"><i className=" me-3 fa-regular fa-calendar-check" />Appointments</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className="nav-link" id="message-tab" data-bs-toggle="pill" data-bs-target="#pills-messages" type="button" role="tab"><i className=" me-3 fa-regular fa-envelope" />Messages</button>
                        </li>
                    </ul>
                    </div>
                    <div className="row">
                        <div className="tab-content" id="pills-tabContent">
                            ...
                            <div className="tab-pane" id="pills-users" role="tabpanel" >
                                <UserListTable />
                            </div>
                            <div className="tab-pane" id="pills-doctors" role="tabpanel" >
                               <DoctorListTable />
                            </div>
                            <div className="tab-pane" id="pills-appointments" role="tabpanel" >
                                <AppointmentListTable />
                            </div>
                            <div className="tab-pane" id="pills-messages" role="tabpanel" >
                                <MessageList/>
                            </div>
                        </div>
                    </div>
